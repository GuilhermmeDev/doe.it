        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div class="p-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
              <label for="share-input" class="block text-sm font-medium text-gray-700 mb-2">Compartilhe:</label>
              <div class="flex space-x-2">
                ...
                <button class="copy-button px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 text-sm transition-colors" id="copy">
                  Copiar
                </button>
              </div>
            </div>
      ...
      <div class="lg:col-span-1">
        <div class="bg-white rounded-lg shadow-sm p-6 sticky top-8">
          ...
          <div class="text-center mb-6">
            <div class="text-sm text-gray-500 mb-1">Arrecadado</div>
            <div class="text-3xl font-bold text-green-500 mb-4">{{$campaign->meta['current']}}
            ...
            <div class="text-lg text-gray-700 mb-4">{{$campaign->meta['target']}}
              @if($campaign->Type === "food")
                <span class="text-sm text-gray-600">Kg</span>
              @else
                <span class="text-sm text-gray-600">Unidades</span>
          ...
          @if ($donation)
            <p class="text-center text-sm text-gray-600 mb-4">
              Veja o qr code da sua doação <a href="/donation/{{$donation->id}}" class="text-blue-500 hover:underline">aqui</a>
            </p>
          ...
          <div class="border-t pt-6">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Sobre a campanha</h2>
            ...
            <h2 class="text-lg font-semibold text-gray-900 mb-4">Local da campanha</h2>
            <ul class="text-sm text-gray-600 space-y-2 mb-6">
    ...
    <div id="invite_modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" style="display: none;">
      <div class="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        <div class="flex justify-between items-center mb-4">
          <h3 class="text-lg font-semibold text-gray-900">Convidar para campanha</h3>
        ...
        <form id="invite_form">
          @csrf
          <div class="mb-4">
            <label for="inviteEmail" class="block text-sm font-medium text-gray-700 mb-2">Digite o e-mail</label>
          ...
          <p class="alert text-sm text-amber-600 bg-amber-50 p-3 rounded-md mb-4">
